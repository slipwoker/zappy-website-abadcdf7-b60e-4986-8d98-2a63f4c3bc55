document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        const validateField = (input) => {
            ...
            if (required && !value) {
                const fieldName = input.getAttribute('data-label') || name || input.placeholder || 'This field';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'abadcdf7-b60e-4986-8d98-2a63f4c3bc55',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'abadcdf7-b60e-4986-8d98-2a63f4c3bc55';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'abadcdf7-b60e-4986-8d98-2a63f4c3bc55';
